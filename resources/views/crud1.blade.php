        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td> <input id="nom" type="text" class="form-control @error('nom') is-invalid @enderror" name="nom" value="{{ old('nom') }}" required autocomplete="nom" autofocus>
                            ...
                            <td> <input id="prenom" type="text" class="form-control @error('prenom') is-invalid @enderror" name="prenom" value="{{ old('prenom') }}" required autocomplete="prenom" autofocus>
                            ...
                            <td> <input id="identifiant" type="identifiant" class="form-control @error('identifiant') is-invalid @enderror" name="identifiant" value="{{ old('identifiant') }}" required autocomplete="identifiant">
